"""
Bilibili Adapter - bilibili 网站适配器
===========================================================
...
class BilibiliAdapter(BaseWebsiteAdapter):
    """"bilibili 网站适配器（通用实现）"""""
    ...
    def get_domains(self) -> list:
        return ['bilibili.com', 'www.bilibili.com']
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_bilibili",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_bilibili"}
