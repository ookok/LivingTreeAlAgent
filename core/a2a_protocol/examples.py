...
async def basic_example():
    ...
    from core.a2a_protocol import Task, TaskStatus
...
async def team_collaboration_example():
    ...
    """
    from core.a2a_protocol.gateway import create_a2a_gateway
    from core.a2a_protocol.task_integration import create_a2a_task_manager
    from core.a2a_protocol.collaboration import (
        create_agent_team, 
        TeamRole,
        AgentTeam
    )
...
async def session_context_example():
    ...
    """
    from core.a2a_protocol.task_integration import create_a2a_task_manager
    from core.a2a_protocol.session import SessionContext
...
async def integrate_with_task_system():
    ...
    """
    from core.a2a_protocol.gateway import create_a2a_gateway
    from core.a2a_protocol.task_integration import (
