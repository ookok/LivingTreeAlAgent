...
from livingtree.tui.td.agent_schema import Action, Agent, OS, Command
...
class AgentModal(ModalScreen):
    ...
    async def on_button_pressed(self) -> None:
        ...
        from livingtree.tui.td.screens.action_modal import ActionModal
        from livingtree.tui.td.screens.command_edit_modal import CommandEditModal
