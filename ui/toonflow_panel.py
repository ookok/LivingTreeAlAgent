...
class ToonflowPanel(QWidget):
    ...
    async def _check_environment(self):
        ...
        if not self.runner:
            try:
                from core.toonflow_runner import get_toonflow_runner
    ...
    async def _do_start_service(self):
        ...
        if success:
            ...
            if not self.client:
                try:
                    from core.toonflow_client import get_toonflow_client
                    from core.toonflow_client import ToonflowConfig
    ...
    async def _do_create_project(self):
        ...
        try:
            from core.toonflow_client import NovelContent
