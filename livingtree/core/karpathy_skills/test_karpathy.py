...
def test_rules_text():
    ...
    from livingtree.core.karpathy_skills import KARPATHY_RULES_TEXT
...
def test_ambiguity_detector():
    ...
    from livingtree.core.karpathy_skills import AmbiguityDetector, get_detector
...
def test_code_complexity():
    ...
    from livingtree.core.karpathy_skills import get_detector
