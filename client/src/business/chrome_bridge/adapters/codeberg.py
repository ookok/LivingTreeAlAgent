"""
Codeberg Adapter - codeberg 网站适配器
===========================================================
...
class CodebergAdapter(BaseWebsiteAdapter):
    """"codeberg 网站适配器（通用实现）"""""
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_codeberg",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_codeberg"}
