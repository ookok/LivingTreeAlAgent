#!/usr/bin/env python3
"""迁移 core/local_file_search 到 client/src/business/local_file_search"""
import os
import shutil
import re

SRC_DIR = "core/local_file_search"
DST_DIR = "client/src/business/local_file_search"
...
def update_internal_imports():
    ...
    for filename in os.listdir(DST_DIR):
        ...
        # 替换 from core.local_file_search 为 from client.src.business.local_file_search
        pattern = r'from\s+core\.local_file_search\s+import'
        replacement = 'from client.src.business.local_file_search import'
...
if __name__ == "__main__":
    print("=" * 60)
    print("Migrating core/local_file_search to client/src/business/")
    print("=" * 60)
