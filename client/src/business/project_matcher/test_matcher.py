...
# 导入项目分析器
from core.project_matcher.project_analyzer import (
    ProjectData, ProjectType, ArchitectureInfo, BusinessInfo,
    CodeStructure
)

# 导入匹配器
from core.project_matcher.surface_matcher import create_surface_matcher
from core.project_matcher.architectural_matcher import create_architectural_matcher
from core.project_matcher.semantic_matcher import create_semantic_matcher
from core.project_matcher.comprehensive_evaluator import create_evaluator
...
# 添加 mock metadata
from core.project_matcher.project_analyzer import GitHubMetadata
