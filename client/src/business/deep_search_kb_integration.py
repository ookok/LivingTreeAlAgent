...
使用方式：
    from business.deep_search_kb_integration import DeepSearchKBIntegration
...
class DeepSearchKBIntegration:
    ...
    def setup_hooks(self):
        ...
        try:
            # 延迟导入避免循环依赖
            from business.knowledge_auto_ingest import get_kb_ingest, get_kb_hooks, ContentSource
    ...
    def ingest_search_results(
        ...
        """
        try:
            from business.knowledge_auto_ingest import get_kb_ingest, ContentSource
    ...
    def ingest_deep_search_result(
        ...
        """
        try:
            from business.knowledge_auto_ingest import get_kb_ingest, ContentSource, KnowledgeEntry
            import hashlib
    ...
    def ingest_session(
        ...
        """
        try:
            from business.knowledge_auto_ingest import get_kb_ingest, ConversationExtractor
    ...
    def get_stats(self) -> Dict[str, Any]:
        """获取统计信息"""
        try:
            from business.knowledge_auto_ingest import get_kb_ingest
