---
name: github-triage
description: Triage GitHub issues through a label-based state machine. Use when user wants to create an issue, triage issues, review incoming bugs or feature requests, prepare issues for an AFK agent, or manage issue workflow. (触发词: Triage GitHub issues through a label-based state machine.)
location: user
---

# github-triage

> **来源**: mattpocock/skills (`github-triage`)
> **原始描述**: Triage GitHub issues through a label-based state machine. Use when user wants to create an issue, triage issues, review incoming bugs or feature requests, prepare issues for an AFK agent, or manage issue workflow.
