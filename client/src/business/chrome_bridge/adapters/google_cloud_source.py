"""
Google Cloud Source Adapter - google_cloud_source 网站适配器
====================================================================
...
class GoogleCloudSourceAdapter(BaseWebsiteAdapter):
    """"google_cloud_source 网站适配器（通用实现）"""""

    def get_name(self) -> str:
        return "google_cloud_source"

    def get_domains(self) -> list:
        return ['source.cloud.google.com']

    def get_homepage(self) -> str:
        return "https://source.cloud.google.com"
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_google_cloud_source",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_google_cloud_source"}
