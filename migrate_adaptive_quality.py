#!/usr/bin/env python3
"""迁移 core/adaptive_quality 到 client/src/business/adaptive_quality"""
import os
import shutil
import re

SRC_DIR = "core/adaptive_quality"
DST_DIR = "client/src/business/adaptive_quality"
...
def update_internal_imports():
    ...
    for filename in os.listdir(DST_DIR):
        ...
        # 替换 from core.adaptive_quality 为 from client.src.business.adaptive_quality
        pattern = r'from\s+core\.adaptive_quality\s+import'
        replacement = 'from client.src.business.adaptive_quality import'
...
if __name__ == "__main__":
    print("=" * 60)
    print("Migrating core/adaptive_quality to client/src/business/")
    print("=" * 60)
