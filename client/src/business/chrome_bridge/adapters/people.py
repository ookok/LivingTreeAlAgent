...
class PeopleAdapter(BaseWebsiteAdapter):
    """"people 网站适配器（通用实现）"""""
    ...
    def get_domains(self) -> list:
        return ['people.com.cn']

    def get_homepage(self) -> str:
        return "https://people.com.cn"
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_people",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_people"}
