"""
Baidu Cloud Adapter - baidu_cloud 网站适配器
=============================================================
...
class BaiduCloudAdapter(BaseWebsiteAdapter):
    """"baidu_cloud 网站适配器（通用实现）"""""

    def get_name(self) -> str:
        return "baidu_cloud"

    def get_domains(self) -> list:
        return ['cloud.baidu.com']
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_baidu_cloud",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_baidu_cloud"}
