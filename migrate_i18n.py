#!/usr/bin/env python3
"""迁移 core/i18n 到 client/src/business/i18n"""
import os
import shutil
import re

SRC_DIR = "core/i18n"
DST_DIR = "client/src/business/i18n"
...
def update_internal_imports():
    ...
    for filename in os.listdir(DST_DIR):
        ...
        # 替换 from core.i18n 为 from client.src.business.i18n
        pattern = r'from\s+core\.i18n\s+import'
        replacement = 'from client.src.business.i18n import'
...
if __name__ == "__main__":
    print("=" * 60)
    print("Migrating core/i18n to client/src/business/")
    print("=" * 60)
