...
from livingtree.tui.td.widgets.directory_input import DirectoryInput
from livingtree.tui.td.widgets.mandelbrot import Mandelbrot
...
class StoreScreen(Screen):
    ...
    async def on_grid_select_selected(self, event: GridSelect.Selected):
        ...
        from livingtree.tui.td.screens.agent_modal import AgentModal
    ...
    async def action_resume(self) -> None:
        from livingtree.tui.td.screens.session_resume_modal import SessionResumeModal
