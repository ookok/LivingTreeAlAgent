"""
Programmers Stack Adapter - programmers_stack 网站适配器
===================================================================
...
class ProgrammersStackAdapter(BaseWebsiteAdapter):
    """"programmers_stack 网站适配器（通用实现）"""""

    def get_name(self) -> str:
        return "programmers_stack"

    def get_domains(self) -> list:
        return ['programmers.stackexchange.com']

    def get_homepage(self) -> str:
        return "https://programmers.stackexchange.com"
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_programmers_stack",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_programmers_stack"}
