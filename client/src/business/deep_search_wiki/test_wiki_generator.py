...
def test_credibility_evaluator():
    """测试可信度评估器"""
    from business.deep_search_wiki.credibility import CredibilityEvaluator
    from business.deep_search_wiki.models import SourceInfo, SourceType
...
async def test_async_generate():
    """测试异步生成"""
    from business.deep_search_wiki.wiki_generator import DeepSearchWikiSystem
