"""
Midjourney Adapter - midjourney 网站适配器
=============================================================
...
class MidjourneyAdapter(BaseWebsiteAdapter):
    """"midjourney 网站适配器（通用实现）"""""

    def get_name(self) -> str:
        return "midjourney"

    def get_domains(self) -> list:
        return ['www.midjourney.com']
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_midjourney",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_midjourney"}
