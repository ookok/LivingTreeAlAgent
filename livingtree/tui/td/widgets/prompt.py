...
from livingtree.tui.td.widgets.highlighted_textarea import HighlightedTextArea
from livingtree.tui.td.widgets.condensed_path import CondensedPath
from livingtree.tui.td.widgets.path_search import PathSearch
from livingtree.tui.td.widgets.plan import Plan
from livingtree.tui.td.widgets.question import Ask, Question
from livingtree.tui.td.widgets.slash_complete import SlashComplete
from livingtree.tui.td.messages import UserInputSubmitted
from livingtree.tui.td.slash_command import SlashCommand
from livingtree.tui.td.prompt.extract import extract_paths_from_prompt
from livingtree.tui.td.acp.agent import Mode
from livingtree.tui.td.path_complete import PathComplete
...
"""
    ...
    def highlight_shell(self, text: str) -> Content:
        ...
        from livingtree.tui.td import danger
...
class Prompt(containers.VerticalGroup):
    ...
    def watch_modes(self, modes: dict[str, Mode] | None) -> None:
        from livingtree.tui.td.visuals.columns import Columns
