#!/usr/bin/env python3
"""迁移 core/self_evolving 到 client/src/business/self_evolving"""
import os
import shutil
import re

SRC_DIR = "core/self_evolving"
DST_DIR = "client/src/business/self_evolving"
...
def update_internal_imports():
    ...
    for filename in os.listdir(DST_DIR):
        ...
        # 替换 from core.self_evolving 为 from client.src.business.self_evolving
        pattern = r'from\s+core\.self_evolving\s+import'
        replacement = 'from client.src.business.self_evolving import'
...
if __name__ == "__main__":
    print("=" * 60)
    print("Migrating core/self_evolving to client/src/business/")
    print("=" * 60)
