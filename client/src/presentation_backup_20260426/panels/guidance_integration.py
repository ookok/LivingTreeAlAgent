...
使用方式：
```python
from .presentation.guidance_integration import AgentChatWithGuidance
...
UI 集成方式：
```python
from .presentation.components import GuidancePanel, GuidanceDisplayMode
...
# ============== 非 PyQt6 测试 ==============
    ...
    print("使用方式：")
    print("1. 导入组件：")
    print("   from .presentation.guidance_integration import AgentChatWithGuidance")
    print()
    print("2. 创建实例：")
