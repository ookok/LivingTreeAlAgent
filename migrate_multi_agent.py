#!/usr/bin/env python3
"""迁移 core/multi_agent 到 client/src/business/multi_agent"""
import os
import shutil
import re

SRC_DIR = "core/multi_agent"
DST_DIR = "client/src/business/multi_agent"
...
def update_internal_imports():
    ...
    for filename in os.listdir(DST_DIR):
        ...
        # 替换 from core.multi_agent 为 from client.src.business.multi_agent
        pattern = r'from\s+core\.multi_agent\s+import'
        replacement = 'from client.src.business.multi_agent import'
...
def update_external_imports():
    ...
    external_files = [
        ...
        "tests/test_phase2_multi_agent.py"
    ]
...
if __name__ == "__main__":
    print("=" * 60)
    print("Migrating core/multi_agent to client/src/business/")
    print("=" * 60)
