"""
Leetcode Adapter - leetcode 网站适配器
===========================================================
...
class LeetCodeAdapter(BaseWebsiteAdapter):
    """"leetcode 网站适配器（通用实现）"""""
    ...
    def get_domains(self) -> list:
        return ['leetcode.com', 'leetcode.cn']
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_leetcode",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_leetcode"}
