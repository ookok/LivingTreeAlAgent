...
class KPZTuner:
    ...
    def __init__(self, population_size: int = 50, target_quality: float = 0.9):
        ...
        self._current_state: Optional[KpzState] = None
        self._generation = 0
    ...
    def _compute_tuning(
        ...
        if phase == KpzPhase.GROWING:
            ...
            return KpzTuning(
                ...
                phase=phase,
                confidence=0.9,
                reason=f"DIVERGENCE: roughness exceeds KPZ bound. Reducing noise term η and increasing diffusion ν.",
            )
    ...
    def get_state(self) -> Optional[KpzState]:
