#!/usr/bin/env python3
"""迁移 core/search_suggestion 到 client/src/business/search_suggestion"""
import os
import shutil
import re

SRC_DIR = "core/search_suggestion"
DST_DIR = "client/src/business/search_suggestion"
...
def update_internal_imports():
    ...
    for filename in os.listdir(DST_DIR):
        ...
        # 替换 from core.search_suggestion 为 from client.src.business.search_suggestion
        pattern = r'from\s+core\.search_suggestion\s+import'
        replacement = 'from client.src.business.search_suggestion import'
...
if __name__ == "__main__":
    print("=" * 60)
    print("Migrating core/search_suggestion to client/src/business/")
    print("=" * 60)
