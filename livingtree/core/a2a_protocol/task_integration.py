...
logger = logger.bind(name='a2a_integration')
...
class TaskConverter:
    ...
    def from_task_node(node, task_context=None) -> 'A2ATask':
        ...
        from . import Task, TaskStatus as A2ATaskStatus
...
class AgentAdapter:
    ...
    def to_endpoint(self) -> 'AgentEndpoint':
        """转换为 A2A 端点"""
        from .channel import AgentEndpoint, TransportType
...
class A2ATaskManager:
    ...
    async def dispatch_task(
        ...
        Returns:
            a2a_task_id
        """
        from . import Task, SessionContext
