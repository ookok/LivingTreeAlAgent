...
Full migration from client/src/business/evolution/

经验记录、技能评估、策略引擎、进化日志、技能发现。
"""

from .experience_system import (
    ExperienceSystem, Experience, SkillUsage, HumanFeedback,
    TaskType, FeedbackType, ExperienceSummary,
)
from .skill_evaluator import (
    SkillEvaluator, Skill, SkillMetric, SkillExample,
    SkillCategory, SkillStatus,
)
from .policy_engine import (
    PolicyEngine, Policy, PolicyRule, PolicyInsight,
...
from .skill_discovery import (
    SkillDiscoveryEngine, PatternMatch, DiscoveryResult,
)
...
class EvolutionSystem:
    ...
    def record_experience(self, task_type, task_description, skills_used,
                          success, execution_time, metadata=None):
    ...
    def add_feedback(self, experience_id, feedback):
    ...
    def run_skill_discovery(self):
        return self.skill_discovery.run_full_discovery()

    def get_evolution_summary(self, days=7):
        return {
    ...
    def suggest_skills(self, task_description):
