...
class StrategicDistiller:
    ...
    _instance: StrategicDistiller | None = None
    ...
    def _save(self):
        try:
            ...
            PRINCIPLES_FILE.write_text(_json_dumps(data))
        except Exception as e:
    ...
    def _load(self):
        try:
            if PRINCIPLES_FILE.exists():
                data = _json_loads(PRINCIPLES_FILE.read_text())
...
_distiller: StrategicDistiller | None = None
