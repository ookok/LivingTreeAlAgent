...
class TestChatPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        model_label = QLabel("Model: deepseek-v4-flash (API)")
    ...
    def _add_test_messages(self):
        """添加测试消息"""
        self._add_message('assistant', '你好！我是 LivingTree AI Agent，很高兴为你服务。')
        self._add_message('user', '我怎么用脚本一键下载安装ollama？')
    ...
    def _add_message(self, role, content):
        ...
        self.messages_layout.insertWidget(self.messages_layout.count(), bubble)
    ...
    def _send_message(self):
        ...
        # 模拟回复
        self._add_message('assistant', '收到你的消息: ' + text)
...
def main():
    ...
    # 创建聊天面板
    chat_panel = TestChatPanel()
    window.setCentralWidget(chat_panel)
    
    # 显示窗口
    window.show()
    
    print('🎉 聊天面板测试窗口已显示')
    print('💡 可以输入消息并点击发送按钮测试')
