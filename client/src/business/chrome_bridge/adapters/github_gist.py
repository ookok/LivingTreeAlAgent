"""
Github Gist Adapter - github_gist 网站适配器
=============================================================
...
class GitHubGistAdapter(BaseWebsiteAdapter):
    """"github_gist 网站适配器（通用实现）"""""
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_github_gist",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_github_gist"}
