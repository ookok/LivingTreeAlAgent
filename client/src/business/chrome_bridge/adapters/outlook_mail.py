"""
Outlook Mail Adapter - outlook_mail 网站适配器
==============================================================
...
class OutlookMailAdapter(BaseWebsiteAdapter):
    """"outlook_mail 网站适配器（通用实现）"""""

    def get_name(self) -> str:
        return "outlook_mail"

    def get_domains(self) -> list:
        return ['outlook.com', 'outlook.office.com']
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_outlook_mail",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_outlook_mail"}
