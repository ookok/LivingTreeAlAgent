...
class PollutionAssessmentReportGenerator:
    ...
    def _generate_docx(
        ...
        **kwargs
        ...
        """生成DOCX格式报告"""
        try:
            from livingtree.core.md_to_doc.docx_generator import DOCXGenerator
            from livingtree.core.md_to_doc.models import DocumentNode, DocumentElement, ElementType
