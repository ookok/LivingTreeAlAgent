...
def test_classifier():
    """测试URL分类器"""
    from core.url_intelligence.url_classifier import URLClassifier
...
def test_mirror_registry():
    """测试镜像源注册表"""
    from core.url_intelligence.mirror_registry import MirrorRegistry
...
async def test_url_optimizer():
    """测试URL优化器"""
    from core.url_intelligence.url_optimizer import URLOptimizer
