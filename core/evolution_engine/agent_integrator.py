...
# 导入 Phase 2 模块
from core.evolution_engine.evolution_integrator import (
    EvolutionConfigIntegrator,
    ConfigResult,
    OptimizationResult,
)
from core.evolution_engine.pipeline_optimizer import (
    PipelineOptimizer,
    PipelineExecutor,
    PipelineConfig,
    TaskType,
...
from core.evolution_engine.dynamic_config_adjuster import (
