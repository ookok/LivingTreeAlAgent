...
使用方法：
    from core.content_monitor import ContentMonitorServer, create_server
    ...
    # 方式3: 使用内容识别
    from core.content_monitor import ContentRecognizer
    recognizer = ContentRecognizer()
    analysis = recognizer.recognize("财务内容...")
    
    # 方式4: 使用归纳汇总
    from core.content_monitor import ContentSummarizer, ContentType
