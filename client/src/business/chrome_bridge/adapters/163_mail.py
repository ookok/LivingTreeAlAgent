"""
163 Mail Adapter - 163_mail 网站适配器
==========================================================
...
class Mail163Adapter(BaseWebsiteAdapter):
    """"163_mail 网站适配器（通用实现）"""""
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_163_mail",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_163_mail"}
