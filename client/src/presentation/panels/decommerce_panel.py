...
class DeCommercePanel(QWidget):
    ...
    def _discover_ai_capabilities(self):
        """探测AI能力"""
        try:
            from core.decommerce import get_ai_capability_registry
    ...
    def _init_super_relay(self):
        """初始化Super Relay"""
        try:
            from core.decommerce import init_edge_relay_network
    ...
    def _start_audit(self):
        """开始审计"""
        try:
            from core.decommerce import get_audit_trail
    ...
    def _start_seller_node(self):
        """启动卖家节点"""
        try:
            from core.decommerce import SellerNode
    ...
    def _publish_service(self):
        ...
        try:
            from core.decommerce import ServiceType
    ...
    def _connect_buyer(self):
        """连接买家客户端"""
        try:
            from core.decommerce import BuyerClient
