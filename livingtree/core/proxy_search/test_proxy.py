...
async def test_fetch_proxies():
    ...
    try:
        from livingtree.core.proxy_search import fetch_proxies
...
async def test_validator(proxies):
    ...
    try:
        from livingtree.core.proxy_search import validate_proxies
...
async def test_proxy_pool():
    ...
    try:
        from livingtree.core.proxy_search import initialize_pool, get_proxy_pool
        from .deep_search_integration import get_integration, SearchMode
...
async def test_middleware():
    ...
    try:
        from livingtree.core.proxy_search import get_middleware, get_proxy_pool
...
async def test_integration():
    ...
    try:
        from .deep_search_integration import initialize_integration, SearchMode
