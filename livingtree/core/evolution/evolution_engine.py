...
class EvolutionEngine:
    ...
    def enable_self_learning(self, enable: bool = True):
        ...
        if enable:
            ...
            try:
                # 1. 强化学习
                from livingtree.core.self_learning.reinforcement import (
                    CodeEvolutionEnv,
                    PPOAgent,
                    RLTrainer,
                    TrainingConfig,
                ...
                # 2. 知识图谱
                from livingtree.core.self_learning.knowledge_graph import (
                    CodeKnowledgeGraph,
                    ASTParser,
                    ImpactAnalyzer,
                )
                ...
                # 3. 迁移学习
                from livingtree.core.self_learning.transfer import (
                    DomainAdapter,
                    TransferTrainer,
                    CodeBERTAdapter,
                )
