...
class MarketplacePanel(QWidget):
    ...
    def _load_products(self):
        ...
        self._products = [
            {"name": "WebSearch Plugin", "author": "System", "price": 0, "rating": 4.5, "category": "插件", "desc": "网络搜索插件，支持多种搜索引擎", "purchased": False},
            {"name": "CodeAnalyzer Plugin", "author": "System", "price": 99, "rating": 4.8, "category": "插件", "desc": "代码分析插件，支持多种编程语言", "purchased": True},
            {"name": "DataVisualizer Plugin", "author": "System", "price": 49, "rating": 4.2, "category": "插件", "desc": "数据可视化插件，支持多种图表类型", "purchased": False},
            {"name": "ReportGenerator Skill", "author": "System", "price": 29, "rating": 4.6, "category": "技能", "desc": "报告生成技能，支持多种报告类型", "purchased": True},
            {"name": "Dark Theme", "author": "System", "price": 0, "rating": 4.9, "category": "主题", "desc": "深色主题，保护你的眼睛", "purchased": False},
        ]
    ...
    def _filter_products(self):
        ...
        for i in range(self.product_list.count()):
            ...
            # 检查搜索文本
            match_search = search_text in product["name"].lower() or search_text in product["desc"].lower()
