...
def test_operation_sequence():
    ...
    from core.ui_evolution.operation_sequence import (
        OperationSequenceDB,
        OperationRecord,
        record_action,
        get_recent_sequence,
...
def test_tfidf_predictor():
    ...
    from core.ui_evolution.tfidf_predictor import (
        TFIDFPredictor,
        predict_next,
        quick_predict,
    )
...
def test_feedback_collector():
    ...
    from core.ui_evolution.feedback_collector import (
        FeedbackCollector,
        FeedbackType,
...
def test_evolution_scheduler():
    ...
    from core.ui_evolution.evolution_scheduler import (
        EvolutionScheduler,
        EvolutionLevel,
        trigger_learning,
        get_evolution_status,
    )
    from core.ui_evolution.tfidf_predictor import TFIDFPredictor
    from core.ui_evolution.feedback_collector import FeedbackCollector
    import tempfile
...
def test_smart_ui_system():
    ...
    from core.ui_evolution.smart_ui_system import (
        SmartUISystem,
        smart_predict,
        record_ui_feedback,
    )
...
def test_hints_integration():
    ...
    try:
        from core.ui_evolution.hints_integration import (
