"""
Docker Hub Adapter - docker_hub 网站适配器
============================================================
...
class DockerHubAdapter(BaseWebsiteAdapter):
    """"docker_hub 网站适配器（通用实现）"""""
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_docker_hub",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_docker_hub"}
