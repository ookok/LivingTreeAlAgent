"""
Wikipedia Adapter - wikipedia 网站适配器
============================================================
...
class WikipediaAdapter(BaseWebsiteAdapter):
    """"wikipedia 网站适配器（通用实现）"""""

    def get_name(self) -> str:
        return "wikipedia"

    def get_domains(self) -> list:
        return ['wikipedia.org', 'en.wikipedia.org']
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_wikipedia",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_wikipedia"}
