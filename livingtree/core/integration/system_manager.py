...
class SystemManager:
    ...
    def _init_integration_layer(self):
        ...
        try:
            ...
            from .integration_coordinator import get_integration_coordinator
    ...
    def _import_subsystem(self, name: str) -> Optional[Any]:
        ...
        module_paths = {
            ...
            'self_healing': 'livingtree.core.self_healing',
            'continual_learning': 'livingtree.core.continual_learning',
            'cognitive_reasoning': 'livingtree.core.cognitive_reasoning',
            'self_awareness': 'livingtree.core.self_awareness',
            'mcp_service': 'livingtree.adapters.mcp',
            'api_gateway': 'livingtree.adapters.api'
        }
