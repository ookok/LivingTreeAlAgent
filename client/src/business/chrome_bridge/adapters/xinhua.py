...
class XinhuaAdapter(BaseWebsiteAdapter):
    """"xinhua 网站适配器（通用实现）"""""
    ...
    def get_domains(self) -> list:
        return ['xinhuanet.com']

    def get_homepage(self) -> str:
        return "https://xinhuanet.com"
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_xinhua",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_xinhua"}
