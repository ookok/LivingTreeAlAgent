...
async def basic_example():
    ...
    基础 A2A 使用示例
    """
    from .gateway import create_a2a_gateway
    from . import Task, TaskStatus
    from .task_integration import create_a2a_task_manager, AgentType
...
async def team_collaboration_example():
    ...
    """
    from .gateway import create_a2a_gateway
    from .task_integration import create_a2a_task_manager
...
async def instant_wake_example():
    ...
    """
    from .gateway import create_a2a_gateway
    from .security import PromptInjectionDetector, ThreatLevel
