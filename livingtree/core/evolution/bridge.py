...
if TYPE_CHECKING:
    from livingtree.core.intent.intent_engine import IntentEngine
    from livingtree.core.intent.intent_engine import Intent, IntentType, IntentPriority
    from livingtree.core.evolution import EvolutionEngine
...
class EvolutionIntentBridge:
    ...
    def _emit_signal(self, signal: IntentSignal):
        ...
        try:
            ...
            # 记录到 PatternMiner
            from livingtree.core.evolution.memory import PatternMiner, get_pattern_miner
    ...
    def report_execution_result(self, feedback: ExecutionFeedback):
        ...
        try:
            # 记录到 LearningEngine
            from livingtree.core.evolution.memory import LearningEngine, get_learning_engine
...
def create_full_bridge() -> EvolutionIntentBridge:
    ...
    """
    from livingtree.core.intent.intent_engine import IntentEngine
    from livingtree.core.evolution import create_evolution_engine
