#!/usr/bin/env python3
"""迁移 core/ui_evolution 到 client/src/business/ui_evolution"""
import os
import shutil
import re

SRC_DIR = "core/ui_evolution"
DST_DIR = "client/src/business/ui_evolution"
...
def update_internal_imports():
    ...
    for filename in os.listdir(DST_DIR):
        ...
        # 替换 from core.ui_evolution 为 from client.src.business.ui_evolution
        pattern = r'from\s+core\.ui_evolution\s+import'
        replacement = 'from client.src.business.ui_evolution import'
...
if __name__ == "__main__":
    print("=" * 60)
    print("Migrating core/ui_evolution to client/src/business/")
    print("=" * 60)
