"""
Aws Codecommit Adapter - aws_codecommit 网站适配器
================================================================
...
class AWSCodeCommitAdapter(BaseWebsiteAdapter):
    """"aws_codecommit 网站适配器（通用实现）"""""

    def get_name(self) -> str:
        return "aws_codecommit"

    def get_domains(self) -> list:
        return ['console.aws.amazon.com/codecommit']

    def get_homepage(self) -> str:
        return "https://console.aws.amazon.com/codecommit"
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_aws_codecommit",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_aws_codecommit"}
