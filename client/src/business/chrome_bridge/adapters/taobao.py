...
class TaobaoAdapter(BaseWebsiteAdapter):
    """"taobao 网站适配器（通用实现）"""""
    ...
    def get_domains(self) -> list:
        return ['taobao.com', 'www.taobao.com']

    def get_homepage(self) -> str:
        return "https://taobao.com"
    ...
    async def extract_content(self, cdp, page_id: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": text,
                "lang": html_lang,
                "extractor": "generic_taobao",
            }
        except Exception as e:
            return {"type": "generic", "error": str(e), "extractor": "generic_taobao"}
