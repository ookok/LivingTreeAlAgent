#!/usr/bin/env python3
"""迁移 core/multi_path_explorer 到 client/src/business/multi_path_explorer"""
import os
import shutil
import re

SRC_DIR = "core/multi_path_explorer"
DST_DIR = "client/src/business/multi_path_explorer"
...
def update_internal_imports():
    ...
    for filename in os.listdir(DST_DIR):
        ...
        # 替换 from core.multi_path_explorer 为 from client.src.business.multi_path_explorer
        pattern = r'from\s+core\.multi_path_explorer\s+import'
        replacement = 'from client.src.business.multi_path_explorer import'
...
if __name__ == "__main__":
    print("=" * 60)
    print("Migrating core/multi_path_explorer to client/src/business/")
    print("=" * 60)
