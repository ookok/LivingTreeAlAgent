#!/usr/bin/env python3
"""迁移 core/project_matcher 到 client/src/business/project_matcher"""
import os
import shutil
import re

SRC_DIR = "core/project_matcher"
DST_DIR = "client/src/business/project_matcher"
...
def update_internal_imports():
    ...
    for filename in os.listdir(DST_DIR):
        ...
        # 替换 from core.project_matcher 为 from client.src.business.project_matcher
        pattern = r'from\s+core\.project_matcher\s+import'
        replacement = 'from client.src.business.project_matcher import'
...
def update_external_imports():
    """更新外部文件中的导入引用"""
    external_files = [
        "docs/PROJECT_MATCHER_ARCHITECTURE.md",
        "docs/LLM_ENHANCED_MATCHER_DESIGN.md",
        "ui/project_match_panel.py"
    ]
...
if __name__ == "__main__":
    print("=" * 60)
    print("Migrating core/project_matcher to client/src/business/")
    print("=" * 60)
