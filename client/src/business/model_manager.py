...
from business.config import AppConfig, OllamaConfig
from business.ollama_client import OllamaClient
from business.model_priority_loader import ModelBackend, LocalModelPriorityLoader
...
class ModelManager:
    ...
    def set_default_model(self, model_name: str):
        ...
        from business.config import save_config
